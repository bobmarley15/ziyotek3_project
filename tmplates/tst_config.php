...
$config->custom->session['blowfish'] = '4382b936c25588e4917fc1e9804ac5ee';  # Autogenerated for ldap.example.local
...
// $servers->setValue('server','base',array('dc=ziyotek3,dc=local'));
...
#  $servers->setValue('login','bind_id','cn=admin,dc=ziyotek3,dc=local');
